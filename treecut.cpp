...
void testcase() {
    ...
    // Sort in reverse
    sort(tree_height.begin(), tree_height.end(), greater<int>());
    // debug() << imie(tree_height);
    // Linear iteration to count the changes
    tree_height.push_back(0);
    // Adding zero at the end of tree_height for last operation
    ll op = 0;
    for(ll i = 0;i < n;i++)
    {
