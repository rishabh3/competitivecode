...
void testcase() {
	// Based on Concept of Inverse permutation
	// Given array [1,3,2,4] the inverse permuation is [1,3,2,4]
	// Basically (1, 1), (2, 3), (3, 2), (4, 4) initial array
	// Output array is (1, 1), (3, 2), (2, 3), (4, 4)
	int n;
	scanf("%d", &n);
	vector<int> f(n), op(n);
	for(int i=0;i<n;i++){
